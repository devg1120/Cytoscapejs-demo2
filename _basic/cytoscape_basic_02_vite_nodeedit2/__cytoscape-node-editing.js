...
for ( ; i < length; i++ ) {
    ...
    //GS var register = function (cytoscape, $, Konva) {
...
/*
    ...
    //GS if (typeof cytoscape !== 'undefined' && typeof jQuery !== "undefined" && typeof Konva !== "undefined") { // expose to global cytoscape (i.e. window.cytoscape)
    //GS     register(cytoscape, jQuery, Konva);
    //GS }
    if (typeof cytoscape !== 'undefined' && typeof Konva !== "undefined") { // expose to global cytoscape (i.e. window.cytoscape)
